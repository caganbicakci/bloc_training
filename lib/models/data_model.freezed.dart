...
class _$_DataModel implements _DataModel {
  ...
  @override
  String toString() {
    return 'DataModel(id: $id, title: $title, worth: $worth, thumbnail: $thumbnail, image: $image, description: $description, instructions: $instructions, openGiveawayUrl: $openGiveawayUrl, type: $type, platforms: $platforms, users: $users, status: $status, gamerpowerUrl: $gamerpowerUrl)';
  }
